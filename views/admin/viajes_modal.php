...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['action']) && $_POST['action'] === 'delete' && isset($_POST['id'])) {
        ...
        $message = 'Viaje eliminado exitosamente'; // Mensaje de éxito 
    }    
}
    ...
    <main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-100">
        <div class="container mx-auto px-6 py-8">
            <div class="flex justify-between items-center mb-4">
                ...
                <button onclick="document.getElementById('create-trip-modal').classList.toggle('hidden')" 
                ...
                <div class="bg-white rounded-lg w-full max-w-md max-h-screen p-6 shadow-lg overflow-y-auto relative">
                    ...
                    <form method="POST" action="">
                        ...
                        <div class="grid grid-cols-1 gap-4">
                            <div class="relative">
                                <label class="block text-sm font-medium text-gray-700 mb-2">Ciudad de partida:</label>
